...
"]"==a&&I()):I()),","==a&&I(),b.push(K(a));return b}if("{"==a){for(b={};a=J(),"}"!=a;c||(c=!0))c&&(","==a?(a=J(),"}"==a&&I()):I()),(","==a||"string"!=typeof a||"@"!=(s?a.charAt(0):a[0])||":"!=J())&&I(),b[a.slice(1)]=K(J());return b}I()}return a},L=function(a,b,c){var d=M(a,b,c);d===f?delete a[b]:a[b]=d},M=function(a,b,c){var d,f=a[b];if("object"==typeof f&&f)if(g.call(f)==q)for(d=f.length;d--;)L(f,d,c);else e(f,function(a){L(f,a,c)});return c.call(a,b,f)};j.parse=function(a,b){var c,d;return E=0,F=""+a,c=K(J()),"$"!=J()&&I(),E=F=null,b&&g.call(b)==m?M((d={},d[""]=c,d),"",b):c}}}h&&define(function(){return j})}(this)},{}],50:[function(a,b){function c(a,b){var c=[];b=b||0;for(var d=b||0;d<a.length;d++)c[d-b]=a[d];return c}b.exports=c},{}],resource:[function(a,b){b.exports=a("xvZeu7")},{}],xvZeu7:[function(a,b){"use strict";function c(a,b,c){this.$shallowClearAndCopy=function(a,b){for(var c in a){var d=a[c];a.hasOwnProperty(c)&&"object"!=typeof d&&"function"!=typeof d&&"$"!==c.charAt(0)&&(b[c]=d)}},this.$name=a,this.$shallowClearAndCopy(c||{},this),this.$socket=b}function d(a){var b=this,c=b.$listeners={save:[],remove:[]};b.$name=a,b.$socket=f.connect(e+b.$name),b.$socket.on("save",function(a,d){for(var e=0,f=c.save.length;f>e;e++)c.save[e](a,b.create(d))}),b.$socket.on("remove",function(a,b){for(var d=0,e=c.remove.length;e>d;d++)c.remove[d](a,b)})}var e="http://localhost:3000/",f=a("socket.io-client");c.prototype.save=function(a){var b=this,c={};this.$shallowClearAndCopy(this,c),this.$socket.emit("save",c,function(c,d){b._id=d._id,a&&a(c,d)})},c.prototype.remove=function(a){if(!this._id)throw"can't remove record without id";this.$socket.emit("remove",this._id,function(b,c){a&&a(b,c)})},d.prototype.get=function(a,b){var d=this;this.$socket.emit("get",a,function(a,e){if(b){var f;if("object"==typeof e){f=[];for(var g=0,h=e.length;h>g;g++)f.push(new c(d.$name,d.$socket,e[g]))}b(a,f)}})},d.prototype.create=function(a){return new c(this.$name,this.$socket,a)},d.prototype.on=function(a,b){if("save"!==a&&"remove"!==a)throw"listener "+a+" is not supported";this.$listeners[a].push(b)},d.prototype.removeListener=function(a,b){var c=this.$listeners[a];if(c){var d,e=c.length;for(d=0;e>d;d++)if(b===c[d]){c.splice(d,1);break}}},d.prototype.removeListeners=function(){this.$listeners.save=[],this.$listeners.remove=[]},d.prototype.disconnect=function(){this.$socket.disconnect()},b.exports=d},{"socket.io-client":1}]},{},["xvZeu7"]);